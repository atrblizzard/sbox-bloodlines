...
namespace Sandbox
{
	public class HackingCamera : Camera
	{
		...
		[ClientCmd( "hackcam_togglehud", Help = "Toggles the HUD when viewing from the camera tool" )]
		public static void SetHud()
		{
			drawHud = !drawHud;
		}

		[ClientCmd( "hackcam_setfov", Help = "Set the fov of the camera tool\nUsage: cam_setfov <number>\nExample: cam_setfov 90" )]
