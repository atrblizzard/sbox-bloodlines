...
public class VRPawnController : EntityComponent<VRPawn>
{
	...
	public void Simulate( IClient cl )
	{
		...
		if ( groundEntity.IsValid() )
		{
			...
			Entity.Velocity = Accelerate( Entity.Velocity, moveVector.Normal, moveVector.Length, 200.0f * (Input.Down( InputButton.Run ) ? 2.5f : 1f), Acceleration );
			Entity.Velocity = ApplyFriction( Entity.Velocity, Friction );
		}
		else
		{
			Entity.Velocity = Accelerate( Entity.Velocity, moveVector.Normal, moveVector.Length, 100, AirAcceleration );
