...
namespace SWB_Base
{
    public class AnimatedAction
    {
        ...
        public string NewViewHandModel { get; set; }
        ...
        private void HandleChanges(WeaponBase weaponBase)
        {
            ...
            if (!string.IsNullOrEmpty(NewViewHandModel))
                weaponBase?.ViewModelHandEntity?.SetModel(isToggled ? NewViewHandModel : weaponBase.ViewModelHandPath);
